...
public class SocketDynamicTableFactory implements DynamicTableSourceFactory {
    ...
    public DynamicTableSource createDynamicTableSource(Context context) {
        final FactoryUtil.TableFactoryHelper tableFactoryHelper =
                FactoryUtil.createTableFactoryHelper(this, context);
        final DecodingFormat<DeserializationSchema<RowData>> decodingFormat =
                tableFactoryHelper.discoverDecodingFormat(
        ...
        return new SocketDynamicTableSource(
                hostname, port, byteDelimiter, decodingFormat, sourceDataType);
    }
