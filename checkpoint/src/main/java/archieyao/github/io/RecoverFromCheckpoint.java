...
public class RecoverFromCheckpoint {
    ...
    /**
     * mvn clean package -Dmaven.test.skip=true 编译时需要设置 maven 依赖的 scope 为 provide ./bin/flink run -c
     * archieyao.github.io.RecoverFromCheckpoint
     * /home/archieao/workspace/flink-training/checkpoint/target/checkpoint-1.0-SNAPSHOT.jar
     * ./bin/flink run -s /tmp/flink-training/3a16d77da5dbdc952541a7a89b60546d/chk-1799 -c
     * archieyao.github.io.RecoverFromCheckpoint
     * /home/archieao/workspace/flink-training/checkpoint/target/checkpoint-1.0-SNAPSHOT.jar
     *
     * @param args
