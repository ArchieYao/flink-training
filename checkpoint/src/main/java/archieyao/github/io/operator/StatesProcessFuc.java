...
public class StatesProcessFuc extends KeyedProcessFunction<
        String,
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        indexState = getRuntimeContext().getState(new ValueStateDescriptor<Long>("indexState", Long.class));
    }
...
//    }
    ...
    @Override
    public void processElement(Tuple3<String, Integer, Long> event,
                               KeyedProcessFunction<String, Tuple3<String, Integer, Long>,
                                       Tuple3<String, Integer, Long>>.Context context,
                               Collector<Tuple3<String, Integer, Long>> collector) throws Exception {
